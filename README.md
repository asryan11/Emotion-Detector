...
## Introduction
This project is a part  of the "Developing AI Applications with Python and Flask" course by IBM provided by Coursera. In this project, you will demonstrate your app creation and web deployment knowledge and skills. The project involves creating an emotion detection application using the Watson AI libraries and deploying it as a web application using Flask. You will also be required to perform various tasks and submit your results using a specific terminology.
